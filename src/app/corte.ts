export interface ICorte {      //leva essa interface para a classe dos produtos
  ...
  export const corte: ICorte[] = [
    ...
    { id: 9, descricao: "Moicano em v", preco: 599.99, descricaoPreco: "À vista no PIX", imagem:"./assets/corte/9.jpg", quantidadeEstoque: 1000},
    { id: 10, descricao: "Social na 2", preco: 599.99, descricaoPreco: "À vista no PIX", imagem:"./assets/corte/10.jpg", quantidadeEstoque: 1000},
    { id: 11, descricao: "Taper fade", preco: 599.99, descricaoPreco: "À vista no PIX", imagem:"./assets/corte/11.jpg", quantidadeEstoque: 1000},
